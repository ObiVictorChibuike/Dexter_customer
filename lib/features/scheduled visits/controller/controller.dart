...
final homeController = Get.put(HomeController());
  ...
  void getCompletedTradeVisitList()async{
    ...
    homeController.outletsWithThursdayScheduledVisit = await LocalCachedData.instance.getThursdayScheduledVisit();
    homeController.outletsWithFridayScheduledVisit = await LocalCachedData.instance.getFridayScheduledVisit();
    final monday = homeController.outletsWithMondayScheduledVisit.where((element) => element.lastvisit!.isBefore(DateTime(today.year, today.month, today.day)) && element.lastvisit!.weekday == 1).toList();
    final tuesday = homeController.outletsWithTuesdayScheduledVisit.where((element) => element.lastvisit!.isBefore(DateTime(today.year, today.month, today.day)) && element.lastvisit!.weekday == 2).toList();
    final wed = homeController.outletsWithWednesdayScheduledVisit .where((element) => element.lastvisit!.isBefore(DateTime(today.year, today.month, today.day)) && element.lastvisit!.weekday == 3).toList();
    final thursday = homeController.outletsWithThursdayScheduledVisit.where((element) => element.lastvisit!.isBefore(DateTime(today.year, today.month, today.day)) && element.lastvisit!.weekday == 4).toList();
    final friday = homeController.outletsWithFridayScheduledVisit.where((element) => element.lastvisit!.isBefore(DateTime(today.year, today.month, today.day)) && element.lastvisit!.weekday == 5).toList();
  ...
  void getPendingVisits()async{
    ...
    homeController.outletsWithThursdayScheduledVisit = await LocalCachedData.instance.getThursdayScheduledVisit();
    homeController.outletsWithFridayScheduledVisit = await LocalCachedData.instance.getFridayScheduledVisit();
    final tradeVisitListMonday = homeController.outletsWithMondayScheduledVisit .where((element) => element.lastvisit!.isAtSameMomentAs(DateTime(today.year, today.month, today.day)) || element.lastvisit!.isAfter(DateTime(today.year, today.month, today.day)) && element.lastvisit!.weekday == 1).toList();
    final tradeVisitListTuesday = homeController.outletsWithTuesdayScheduledVisit.where((element) => element.lastvisit!.isAtSameMomentAs(DateTime(today.year, today.month, today.day)) || element.lastvisit!.isAfter(DateTime(today.year, today.month, today.day)) && element.lastvisit!.weekday == 2).toList();
    final tradeVisitListWednesday =  homeController.outletsWithWednesdayScheduledVisit.where((element) => element.lastvisit!.isAtSameMomentAs(DateTime(today.year, today.month, today.day)) || element.lastvisit!.isAfter(DateTime(today.year, today.month, today.day)) && element.lastvisit!.weekday == 3).toList();
    final tradeVisitListThursday = homeController.outletsWithThursdayScheduledVisit .where((element) => element.lastvisit!.isAtSameMomentAs(DateTime(today.year, today.month, today.day)) || element.lastvisit!.isAfter(DateTime(today.year, today.month, today.day)) && element.lastvisit!.weekday == 4).toList();
    final tradeVisitListFriday = homeController.outletsWithFridayScheduledVisit.where((element) => element.lastvisit!.isAtSameMomentAs(DateTime(today.year, today.month, today.day)) || element.lastvisit!.isAfter(DateTime(today.year, today.month, today.day)) && element.lastvisit!.weekday == 5).toList();
